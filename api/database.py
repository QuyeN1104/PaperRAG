...
Use SQLAlchemy asynchronous engine to manage SQLite connections and support FastAPI life cycle。
"""
...
async def close_db() -> None:
    ...
    Called when the FastAPI application is closed。
    """
...
async def get_db_session() -> AsyncGenerator[AsyncSession, None]:
    """
    Gets the context manager for the database session.

    For direct use in routing：
