...
definition Conversation/Message As well as models related to paper versioning and ingestion tasks。
"""
...
class Conversation(Base):
    ...
    Stores the metadata of the conversation and has a one-to-many relationship with the message。
    """
...
class Message(Base):
    ...
    Stores the content and metadata of a single message, in a many-to-one relationship with the conversation。
    """
